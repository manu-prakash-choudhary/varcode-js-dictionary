...
const HTMLList = () => {
    return (
        <div className='content-container overflow-y-auto min-h-screen pl-6 pr-6 text-lg tracking-wide'>
            <div className='border-b pb-3 border-gray-200 '>
                <h1 className="text-3xl font-semibold">HTML Lists</h1>
            ...
            <h2 className="text-2xl font-semibold mt-4">Types of HTML Lists</h2>
            ...
            <h2 className="text-2xl font-semibold mt-6">Basic Example of HTML Lists</h2>
            ...
            <h2 className="text-2xl font-semibold mb-4 mt-4">HTML List Tags</h2>
            ...
            <h3 className="text-xl font-semibold mt-6">Table of Content</h3>
            ...
            <div className='mt-4'>
                <p className="text-xl font-semibold mb-2">1. Using HTML Unordered List or Bulleted List</p>
                <p className="mb-4">
    ...
    <li>Item 3</li>
            ...
            <div className='mt-4'>
                <p className="text-xl font-semibold mb-2">2. Using HTML Ordered List</p>
                <p className="mb-4">
    ...
    <li>Item 3</li>
            ...
            <div className='mt-5'>
                <p className="text-2xl font-semibold mb-2">3. Using HTML Description List</p>
                <p className="mb-4">
    ...
    <dd>Description of Item 2</dd>
            ...
            <p className="text-2xl font-semibold mb-4 mt-4">Best Practices for Using HTML Lists</p>
            <ul className="list-disc pl-5">
                <li>
