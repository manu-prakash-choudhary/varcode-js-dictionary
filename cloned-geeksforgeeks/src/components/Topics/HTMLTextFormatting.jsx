...
const HTMLTextFormatting = () => {
  return (
    <div className="content-container overflow-y-auto h-screen pl-6">
      ...
      <div className="text-3xl font-semibold mb-4 text-red-600 mt-5">
      ...
      <div className="text-2xl font-bold mb-3">1. Logical Tags</div>
      <p className="mb-4">
      ...
      <div className="text-2xl font-bold mb-3">2. Physical Tags</div>
      <p className="mb-4">
      ...
      <div className="text-l  mb-6 mt-6">
      ...
      <table className="w-full border-collapse mb-12">
        <thead>
          <tr className="bg-gray-100">
            <td className="border p-3 font-semibold">Tags</td>
        ...
        <tbody>
          <tr>
            ...
            <td className="border p-3">Showcases italicized text.</td>
          </tr>
          <tr>
            <td className="border p-3">
              <a href="#" className="text-red-600">
            ...
            <td className="border p-3">Renders text in a smaller font size.</td>
          </tr>
          <tr>
            <td className="border p-3">
              <a href="#" className="text-red-600">
            ...
            <td className="border p-3">Highlights added or inserted text.</td>
          </tr>
          <tr>
            <td className="border p-3">
              <a href="#" className="text-red-600">
            ...
            <td className="border p-3">Creates subscript text.</td>
          </tr>
          <tr>
            <td className="border p-3">
              <a href="#" className="text-red-600">
          ...
          <tr>
            ...
            <td className="border p-3">Displays text in a bold format.</td>
          </tr>
          <tr>
            <td className="border p-3">
              <a href="#" className="text-red-600">
          ...
          <tr>
            ...
            <td className="border p-3">Formats text as superscript.</td>
          </tr>
        </tbody>
      </table>
      ...
      <div className="text-gray-700 mt-5 mb-5">
        ...
        <img src="/tf/t1.png" className="h-50 ml-80 w-80"></img>
      </div>
      <div className="text-gray-700 mt-5 mb-5">
        <h4 className="text-gray-800 text-lg">
        ...
        <h4 className="text-red-600 font-semibold text-lg">Output:</h4>
        <img src="/tf/t2.png" className="h-50 ml-80 w-80"></img>
      </div>
    </div>
  );
};
