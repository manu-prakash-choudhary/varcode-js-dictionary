...
const HTMLColors = () => {
  return (
    <div className="content-container overflow-y-auto h-screen px-4 sm:px-6 md:pl-6">
      <div className="flex flex-col gap-3">
        <h1 className="text-3xl sm:text-4xl font-semibold text-red-600">HTML Colors</h1>
        <p className="text-sm sm:text-base text-gray-600">Last Updated : 30 Mar, 2025</p>
      </div>

      <p className="mb-4 sm:mb-6 mt-4 sm:mt-6 text-sm sm:text-base">
      ...
      <div className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 mt-6 sm:mt-8">HTML Colors Name</div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4 mb-4 sm:mb-6">
        <div className="bg-red-600 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Red
        </div>
        <div className="bg-green-700 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Green
        </div>
        <div className="bg-blue-600 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Blue
        </div>
        <div className="bg-pink-300 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Pink
        </div>
        <div className="bg-purple-800 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Purple
        </div>
        <div className="bg-blue-300 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Sky Blue
        </div>
        <div className="bg-gray-500 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Gray
        </div>
        <div className="bg-orange-500 text-white p-2 sm:p-4 rounded-md text-center font-bold text-sm sm:text-base">
          Orange
        </div>
      </div>

      <div className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">HTML Color Usage</div>

      <div className="overflow-x-auto -mx-4 sm:mx-0">
        <div className="min-w-full px-4 sm:px-0">
          <table className="w-full border-collapse mb-6 sm:mb-8 text-xs sm:text-sm md:text-base">
            <thead>
              <tr className="bg-gray-100">
                <th className="border p-2 sm:p-3 text-left">Usage</th>
                <th className="border p-2 sm:p-3 text-left">Descriptions</th>
                <th className="border p-2 sm:p-3 text-left">Syntax</th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                <td className="border p-2 sm:p-3">Text Color</td>
                <td className="border p-2 sm:p-3">
      ...
      <div className="text-gray-700 mt-4 sm:mt-5 mb-4 sm:mb-5">
        <h3 className="text-lg sm:text-xl font-semibold text-red-600 mt-4 sm:mt-5">
          HTML Colors Example:
        </h3>
        ...
        <p className="text-base sm:text-lg text-red-600 mt-3 sm:mt-5 font-bold">Output :</p>
        <div className="max-w-full overflow-x-auto">
          <img src="/colors/c1.png" className="ml-0 sm:ml-30 max-w-full h-auto" alt="HTML Colors Example Output"></img>
        </div>
        <h3 className="text-lg sm:text-xl font-semibold text-red-600 mt-4 sm:mt-5">
          HTML Colors Example Explanation:
        </h3>
        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 mt-3 sm:mt-5 text-base sm:text-lg">
          <li>
      ...
      <h3 className="text-lg sm:text-xl font-semibold text-red-600 mt-4 sm:mt-5">Color Values</h3>
      <p className="text-gray-700 mt-3 sm:mt-5 mb-3 sm:mb-5 text-sm sm:text-base">
      ...
      <div className="text-gray-700">
        ...
        <p className="text-gray-700 mt-3 sm:mt-5 mb-3 sm:mb-5 text-sm sm:text-base">Some properties are:</p>
        ...
        <div className="bg-gray-100 p-2 sm:p-3 text-gray-700 rounded mt-3 sm:mt-5 text-xs sm:text-sm">
          <pre>
            // Blue background
            <br></br>
        ...
        <p className="text-base sm:text-lg text-red-600 mt-3 sm:mt-5 font-bold">Output :</p>
        <div className="max-w-full overflow-x-auto">
          <img src="/colors/c2.png" className="ml-0 sm:ml-30 max-w-full h-auto" alt="RGB Color Example Output"></img>
        </div>
        <h3 className="text-lg sm:text-xl font-semibold text-red-600 mt-4 sm:mt-5">
      ...
      <div className="text-gray-700">
        ...
        <p className="text-base sm:text-lg text-red-600 mt-3 sm:mt-5 font-bold">Output :</p>
        <div className="max-w-full overflow-x-auto">
          <img src="/colors/c3.png" className="ml-0 sm:ml-30 max-w-full h-auto" alt="RGBA Color Example Output"></img>
        </div>
        <h3 className="text-lg sm:text-xl font-semibold text-red-600 mt-4 sm:mt-5">
      ...
      <div className="text-gray-700">
        ...
        <p className="text-base sm:text-lg text-red-600 mt-3 sm:mt-5 font-bold">Output :</p>
        <div className="max-w-full overflow-x-auto">
          <img src="/colors/c4.png" className="ml-0 sm:ml-30 max-w-full h-auto" alt="HEX Color Example Output"></img>
        </div>
        <h3 className="text-lg sm:text-xl font-semibold text-red-600 mt-4 sm:mt-5">
      ...
      <div className="text-gray-700">
        ...
        <p className="text-base sm:text-lg text-red-600 mt-3 sm:mt-5 font-bold">Output :</p>
        <div className="max-w-full overflow-x-auto">
          <img src="/colors/c5.png" className="ml-0 sm:ml-30 max-w-full h-auto" alt="HSL Color Example Output"></img>
        </div>
        <h3 className="text-lg sm:text-xl font-semibold text-red-600 mt-4 sm:mt-5">
