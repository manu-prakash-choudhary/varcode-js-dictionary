    ...
    <div className="content-container overflow-y-auto h-screen p-6">
      ...
      As we know, Unicode is a system that assigns a unique number (code point) to every character, symbol, or emoji, making it possible for different devices and platforms to display the same character consistently.
        ...
        <div className="bg-[#eeeeee] p-4 rounded-2xl mb-4">
          <p><b>Emojis</b> are just special Unicode characters displayed as images.</p>
        </div>
      <p>In HTML, emojis are typically included using their Unicode escape sequences or directly as characters. Emojis are usually rendeblack as images by browsers, but in the backend, they are just text characters with unique Unicode code points.</p>
      <p style={{ fontWeight: "bold", color: "black", paddingBottom: "10px" }}>Adding Emojis in HTML Code</p>
      <div className="border border-black-400 rounded-2xl w-full min-h-20 bg-[#fafafa] mb-4">
        <CopyBlock
      ...
      <p><b className="text-lg font-bold text-black-600">HTML Emojis Examples</b></p>
      <br/>
      <p className="text-lg font-bold">1. HTML Emojis using Unicode Decimal reference</p>
      ...
      <p><b>Example 1 : </b>Represent the following emoji in a webpage.</p>
      <p style={{ fontWeight: "bold", color: "black", paddingBottom: "10px" }}>Adding Emojis in HTML Code</p>
      <div className="border border-black-400 rounded-2xl w-full min-h-20 bg-[#fafafa] mb-4">
        <CopyBlock
      ...
      <div>
        <p><b className="text-lg font-bold text-600">Explanation :</b></p>
     ...
     <div className="flex mt-4">
        ...
        <thead>
          <tr style={{ backgroundColor: "#f5f5f5", borderBottom: "2px solid #ddd" }}>
            <th style={{ padding: "10px", border: "1px solid #ddd", textAlign: "center", color: "black" }}>Emoji</th>
            <th style={{ padding: "10px", border: "1px solid #ddd", textAlign: "center", color: "black" }}>Decimal</th>
            <th style={{ padding: "10px", border: "1px solid #ddd", textAlign: "center", color: "black" }}>HexaDecimal</th>
          </tr>
        </thead>
          <tbody>
            <tr>
      ...
      <br/>
      <div>
      <p className="text-lg font-bold">2. HTML Emojis using Unicode hexadecimal reference</p>
      <p >
      ...
      <p><b>Example 2 : </b>In this example, we will represent &#128516, &#9996and &#128350 emoji in a webpage with hexadecimal(hex) reference.</p>
      <div className="border border-black-400 rounded-2xl w-full min-h-20 bg-[#fafafa] mb-4 ">
        <CopyBlock
      ...
      <div>
       ...
       <p><b>Note :</b> Since Emojis are characters, they can be copied, displayed and sized just like any other character in HTML.</p>
    </div>
    <p><b className="text-lg font-bold text-black-600">Change Size of Emoji Using CSS</b></p>

    <div>
    <p><b>Example 3 : </b>In this example, we will change the font size of the following emojis.</p>
      <div className="border border-black-400 rounded-2xl w-full min-h-20 bg-[#fafafa] mb-4 ">
        <CopyBlock
      ...
      <div className="flex justify-center flex-col mt-4">
        <p><b>Output :</b> The output contains the different sizes of emojis.</p>
