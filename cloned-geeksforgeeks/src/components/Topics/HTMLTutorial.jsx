...
const HomeSection = () => {
  return (
    <>
      <div className="content-container overflow-y-auto min-h-screen px-4 md:px-6 max-w-full">
        <div className="flex flex-col gap-3 mb-6">
          <h1 className="text-3xl md:text-4xl font-semibold text-red-600">HTML Tutorial</h1>
        ...
        <div className="mt-4">
          ...
          <div className="flex justify-center items-center w-full mt-4 bg-red-100 rounded-2xl">
            <p className="text-black text-justify p-4 md:p-6">
              <i>
        ...
        <section className="mt-8 md:mt-10 flex flex-col gap-3">
        ...
        <section className="mt-8 md:mt-10 flex flex-col gap-3">
          ...
          <div>
            <ol className="pl-4 text-base md:text-lg space-y-2">
        ...
        <section className="mt-8 md:mt-10 flex flex-col gap-3">
          ...
          <div>
            <ul className="pl-4 text-base md:text-lg space-y-2">
        ...
        <section className="mt-8 md:mt-10 flex flex-col gap-3">
          ...
          <div>
            <ol className="pl-4 text-base md:text-lg space-y-3">
              <li className="list-decimal">
        ...
        <section className="mt-8 md:mt-10 flex flex-col gap-3">
          ...
          <div>
            <ol className="pl-4 text-base md:text-lg space-y-3">
              <li className="list-decimal">
                <b>Website Development:</b> HTML forms the structure of websites,
        ...
        <div className="my-8 md:my-10 w-full">
          <div className="flex justify-end items-center">
            <button className="text-base md:text-lg border border-red-400 flex items-center rounded-2xl p-3 md:p-4 font-semibold hover:scale-95 duration-200 hover:text-gray-800 cursor-pointer">
              Next Article
