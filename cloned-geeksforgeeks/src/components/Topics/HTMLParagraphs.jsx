  ...
  return (
    <div className="content-container overflow-y-auto h-screen pl-6">
      <div className="pl-0 flex flex-col gap-3 ">
        <h1 className="text-4xl font-semibold text-red-600">HTML Paragraphs</h1>
      ...
      <h3 className="text-xl font-semibold text-red-600 mt-6">Syntax:</h3>
      ...
      <div className="text-gray-700 mt-5 mb-5">
        <h4 className="text-gray-700 mt-5 mb-5 text-lg">
        ...
        <img src="/Paragraphs pic/p1.png" className="h-20 w-80 ml-100"></img>
      </div>
      <h3 className="text-xl font-semibold text-red-600 mt-6">
        Properties of the paragraph Tag:
      </h3>
      <ul className="text-gray-700 mt-5 mb-5 list-disc ml-10">
        <li className="mt-3">
      ...
      <div className="text-gray-700 mt-5 mb-5">
        ...
        <h4 className="text-red-600 font-semibold text-lg">Output:</h4>
        <img src="/Paragraphs pic/p2.png" className="h-30 ml-80"></img>
      </div>
      <div className="text-gray-700 mt-5 mb-5">
        <h3 className="text-2xl font-semibold text-red-600 mt-6">
          The &lt;br&gt; tag
        </h3>
        <h4 className="text-red-600 font-semibold text-lg mt-5">Syntax:</h4>
        <div className="bg-gray-100 p-3  text-gray-700 rounded mt-5">
          <code>&lt;br&gt;</code>
        </div>
        <h4 className="text-gray-700 mt-5 mb-5 text-lg">
        ...
        <h4 className="text-red-600 font-semibold text-lg">Output:</h4>
        <img src="/Paragraphs pic/p3.png" className="h-50 ml-80 w-80"></img>
      </div>
      ...
      <div className="text-gray-700 mt-5 mb-5">
        ...
        <h4 className="text-red-600 font-semibold text-lg">Output:</h4>
        <img src="/Paragraphs pic/p4.png" className="h-50 ml-80 "></img>
      </div>
      ...
      <div className="text-gray-700 mt-5 mb-5">
        ...
        <div className="bg-gray-50 p-3  text-gray-700 rounded mt-5">
          <h5>
        ...
        <h4 className="text-red-600 font-semibold text-lg">Output:</h4>
        <img src="/Paragraphs pic/p5.png" className="h-50 ml-80 "></img>
      </div>
      ...
      <div className="text-gray-700 mt-5 mb-5">
        ...
        <h4 className="text-red-600 font-semibold text-lg">Output:</h4>
        <img src="/Paragraphs pic/p6.png" className="h-50 ml-80 "></img>
      </div>
      <div className="text-gray-700 mt-5 mb-5">
        <h3 className="text-2xl font-semibold text-red-600 mt-6">
        ...
        <ol className="list-decimal ml-10">
            <li className="mt-5">
                ...
                <p>You cannot nest paragraphs within one another. Each &lt;p&gt; tag should contain only the text for one block of content.</p>
            </li>
            <li className="mt-5">
                <b>Avoid Using &lt;p&gt; for Non-Textual Content: </b>
                <p>The &lt;p&gt; tag is meant for text-based content. If you need to wrap images, tables, or other elements, use appropriate tags like &lt;img&gt;, &lt;table&gt;, or &lt;div&gt;.</p>
            </li>
        </ol>
      </div>
    </div>
