    ...
    return (
        <div className='content-container overflow-y-auto min-h-screen pl-6 pr-6 text-lg tracking-wide'>
            <div className='border-b pb-3 mb-3 border-gray-200 '>
                <h1 className="text-3xl font-semibold">HTML Computer Code Elements</h1>
                <p className="text-gray-500 text-sm mt-3">Last Updated : 25 March, 2025</p>
            </div>
            <div className='mt-1'>
                <h1 className="text-2xl font-semibold mb-4">HTML Code Display Elements</h1>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-2">The &lt;code&gt; Tag</h2>
                <p className="mb-4">
            ...
            <div className='mt-4'>
                <div className="text-2xl font-semibold mb-3">The &lt;kbd&gt; Tag</div>
            ...
            <div className='mt-4'>
                <div className="text-2xl font-semibold mb-3">The pre Tag</div>
            ...
            <div className='mt-4'>
                <div className="text-2xl font-semibold mb-3">The samp Tag</div>
            ...
            <div className='mt-4'>
                <div className="text-2xl font-semibold mb-3">The var Tag</div>
            ...
            <div className='mt-6'>
                <div className="text-2xl font-semibold mb-4">Quick Summary:</div>
