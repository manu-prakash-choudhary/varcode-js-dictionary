...
const HTMLUrlEncoding = () => {
  return  (
    <div className="content-container overflow-y-auto h-screen p-6">
      ...
      <div>
        <p>
          <b>A Uniform Resource Locator (URL)</b> is simply the <b>address of a website</b> to access the website content. Web browsers retrieve pages from web servers using a URL (Uniform Resource Locator).
        </p>
      </div>
      <br/>
      <div>
        <p className="text-lg font-bold text-600">What is URL Encoding?</p>
        ...
        <p >
          <b>For example,</b> a space is not acceptable in a URL and is replaced by a ‘%20’ or a ‘+’ sign while encoding. Similarly, a $ sign is replaced by ‘%24’.
        </p>
      </div>
      <br/>
      <div>
        <p className="text-lg font-bold text-600">URL Syntax</p>
        <p>
      ...
      <div>
          <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
            <li><b>Scheme :</b> It specifies the protocol used for communication, such as “https://” for secure communication or “http://” for unsecublack communication.</li>
            <li><b>Prefix :</b> It is an optional subdomain or www indicating the location of the resource within the domain.</li>
            <li><b>Domain :</b> Identifies the website’s primary address, like “example.com”, indicating its unique location on the Internet.</li>
            <li><b>Port :</b> Optional and signifies a specific endpoint for communication. Common values are 80 for HTTP and 443 for HTTPS.</li>
      ...
      <br/>
      <div>
        <p className="text-lg font-bold text-600 padding-bottom-5">Reserved Characters</p>
      ...
      <div className="flex mt-4">
              ...
              <thead>
                <tr style={{ backgroundColor: "#f5f5f5", borderBottom: "2px solid #ddd" }}>
                  ...
                  <th style={{ padding: "10px", border: "1px solid #ddd", textAlign: "center", color: "black" }}>Encoded Form</th>
                </tr>
              </thead>
                <tbody>
                <tr>
      ...
      <div>
        <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
          <li>
            <b>Safe Characters :</b> Alphanumeric i.e. 0-9, a-z, and A-Z, special characters $, -, _, ., +, !, *, ‘, (, ), are reserved characters used for their reserved purposes. These characters have no need to be encoded.
          </li>
          <li>
            <b>ASCII Control characters :</b> It includes characters ranging from 00-1F in hex (0-31 decimal) and 7F (127 decimal). These characters need to be encoded.
          </li>
          <li>
            <b>Non-ASCII Control characters :</b> It includes 80-FF in hex (128-255 decimal). These characters need to be encoded.
          </li>
          <li>
            <b>Reserved characters :</b> These characters are used for a special purpose and they require encoding.
          </li>
          <li>
            <b>Unsafe characters :</b> This character can be misunderstood within URLs for various reasons. So it requires encoding. The characters <b>&lt;</b> and <b>&gt;</b> are unsafe because they are used as the delimiters around URLs in free text, the quote mark (” “) is unsafe as it is used to delimit URLs in some systems.
          </li>
        </ul>
      </div>
      <br/>
      <p className="text-lg font-bold text-600">Unsafe characters</p>
      <div>
      <div className="flex mt-4">
              <table className="table-auto border-collapse border border-gray-600">
              <thead>
      ...
      <br/>
      <div>
        <p className="text-lg font-bold text-600">URL Encoded Characters</p>
      </div>
      <div>
      <div className="flex mt-4">
              <table className="table-auto border-collapse border border-gray-600">
