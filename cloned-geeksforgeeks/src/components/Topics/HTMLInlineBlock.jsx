    ...
    return (
        <div className='content-container overflow-y-auto min-h-screen pl-6 pr-6 text-lg tracking-wide'>
            <div className='border-b pb-3 mb-3 border-gray-200 '>
                <h1 className="text-3xl font-semibold">HTML Block and Inline Elements</h1>
            ...
            <p class="text-2xl font-semibold mt-5 mb-3">Block Level Elements:</p>
            <p class="mb-4">
            ...
            <p class="text-2xl font-semibold mt-5 mb-3">div element:</p>
            <p class="mb-4">
            ...
            <p class="text-2xl font-semibold mt-5 mb-3">Inline Elements:</p>
            <p class="mb-4">
            ...
            <p className='text-2xl font-semibold mb-3'>Supported tags:</p>
            {
                arr2.map((item, index) => (
                    <ul key={index} class="list-disc pl-5 underline text-red-500">
                        <li class="mb-2"> <Link to={`/html/tags/${item}`}>&lt;{item}&gt; Tag</Link></li>
            ...
            <p class="text-2xl font-semibold mt-5 mb-3">span element:</p>
            <p class="mb-4">
